      ...
      const users = await User.find({
        location: {
          $near: {
            ...
            $maxDistance: 12500 * 1609.34, // Convert miles to meters (1 mile = 1609.34 meters), we will use half of the distance of the largest possible circumfrence of the earth to return all users until we need a smaller API call
          },
        },
      }).populate([
        "room",
